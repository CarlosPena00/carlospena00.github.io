...
| **teus** | `Bm` |
| **braços** | `B7` |
| **só você que não vê** | `Em` |
| **que a falta de você** | `G` |
| **tá doendo em mim** | `A` |
...
Logo depois de **braços** entra o `Em` - que é exatamente pra onde o `B7` estava puxando. É esse encaixe que faz a escolha do `B7` valer.
...
Os quatro da sessão 1, mais os três novos:
